...
class PhotoWeatherTips {
    ...
    func getPhotoTip(condition: Int) -> String {
        ...
        case 500...600 :
            return "Showers, light rain, moderate rain, heavy rain, extreme rain"
        ...
        case 800 :
            return """
            Sunny: Take advantage of the sun light.
            Right sun can create a scenario where you have beautiful light and the ability to experiment with shadows.
            A great tip for photographing in the bright midday sun is taking pictures in open shade.
            """
            
        case 801...804 :
            return "Cloudy/Overcast: We love clouds! \nOvercast days are known for their diffused light.\nIdeal conditions for shooting portraits as your\nsubject will be evenly lit and there are no undesirable shadows or harsh lighting."
